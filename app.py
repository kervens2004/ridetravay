...
def stripe_webhook():
    ...
    try:
        ...
        obj = stripe_to_dict(event["data"]["object"])
        ...
        if event_type == "checkout.session.completed":
            ...
            if passenger_id and ride_id and checkout_session_id:
                ride = db.execute(
                ...
                sub = db.execute("""
                    ...
                    ORDER BY id DESC
                    LIMIT 1
                """, (passenger_id, checkout_session_id)).fetchone()
